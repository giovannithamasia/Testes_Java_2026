...
import entrega_atividades.Aula5.Desconto;
...
class DescontoTest {
    ...
    void calcularDeveAplicarPercentual(
        ...
        double obtido = entrega_atividades.Aula5.Desconto.calcular(preco, percentual);
    ...
    void precoNegativoDeveLancarExcecao(double preco) {
        IllegalArgumentException excecao = assertThrows(
                ...
                () -> entrega_atividades.Aula5.Desconto.calcular(preco, 10)
        );
    ...
    void percentualForaDoIntervaloDeveFalhar(int percentual) {
        IllegalArgumentException excecao = assertThrows(
                IllegalArgumentException.class,
                () -> entrega_atividades.Aula5.Desconto.calcular(100.0, percentual)
        );
